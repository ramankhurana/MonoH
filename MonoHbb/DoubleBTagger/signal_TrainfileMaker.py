...
outfilename= "MZp-2000_MA0-300_train_ptreweight.root"
weight_file = TFile('pt_reweight.root')
pt_weight   =weight_file.Get('h_pt_weight')
        ...
        if len(CA15Puppi_ptPruned) > 0 & (170 < CA15Puppi_ptPruned < 1000) & (50 < CA15Puppi_massPruned < 200) :
            ...
            try:
                ...
                if len(Subjets_0)==2:# & (Subjets_0[0] > 0) & (Subjets_0[1] > 0):
                    ...
                    xbin1 = pt_weight.GetXaxis().FindBin(CA15Puppi_ptPruned[0])
                    weight[0] = pt_weight.GetBinContent(xbin1)
                ...
                print "There is problem in csv , skipping event"
